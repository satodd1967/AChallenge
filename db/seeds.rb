...
# User Logs
krisl1 = Log.create(log_date: (Time.current.strftime("%y-%m-%d").to_date + 1), worked_out: "1", tracked_food: "1", weight: "134.57", body_fat: ".2275", active_calories: "600", calories: "2200", user: kris)
krisl3 = Log.create(log_date: (Time.current.strftime("%y-%m-%d").to_date + 2), worked_out: "0", tracked_food: "1", weight: "132.57", body_fat: ".2075", active_calories: "800", calories: "2500", user: kris)
krisl2 = Log.create(log_date: (Time.current.strftime("%y-%m-%d").to_date + 3), worked_out: "0", tracked_food: "0", weight: "133.57", body_fat: ".2175", active_calories: "700", calories: "2300", user: kris)
timl1 = Log.create(log_date: (Time.current.strftime("%y-%m-%d").to_date + 1), worked_out: "1", tracked_food: "1", weight: "165.57", body_fat: ".2575", active_calories: "300", calories: "3200", user: tim)
timl2 = Log.create(log_date: (Time.current.strftime("%y-%m-%d").to_date + 2), worked_out: "0", tracked_food: "1", weight: "164.57", body_fat: ".25", active_calories: "400", calories: "3200", user: tim)
timl3 = Log.create(log_date: (Time.current.strftime("%y-%m-%d").to_date + 3), worked_out: "1", tracked_food: "0", weight: "163.57", body_fat: ".2475", active_calories: "500", calories: "3200", user: tim)
patrickl1 = Log.create(log_date: (Time.current.strftime("%y-%m-%d").to_date + 13), worked_out: "1", tracked_food: "1", weight: "185.57", body_fat: ".2975", active_calories: "600", calories: "3200", user: patrick)
patrickl2 = Log.create(log_date: (Time.current.strftime("%y-%m-%d").to_date + 14), worked_out: "0", tracked_food: "1", weight: "184.57", body_fat: ".2875", active_calories: "600", calories: "3200", user: patrick)
patrickl3 = Log.create(log_date: (Time.current.strftime("%y-%m-%d").to_date + 15), worked_out: "1", tracked_food: "0", weight: "183.57", body_fat: ".2775", active_calories: "600", calories: "3200", user: patrick)
joel1 = Log.create(log_date: (Time.current.strftime("%y-%m-%d").to_date + 30), worked_out: "1", tracked_food: "1", weight: "185.57", body_fat: ".2975", active_calories: "600", calories: "3200", user: joe)
joel2 = Log.create(log_date: (Time.current.strftime("%y-%m-%d").to_date + 31), worked_out: "0", tracked_food: "1", weight: "184.57", body_fat: ".2875", active_calories: "600", calories: "3200", user: joe)
joel3 = Log.create(log_date: (Time.current.strftime("%y-%m-%d").to_date + 32), worked_out: "1", tracked_food: "1", weight: "183.57", body_fat: ".2775", active_calories: "600", calories: "3200", user: joe)

# Challenge 1
c1 = Challenge.create(name: "Kris's Fat Buster Challenge", description: "Busting fat before fat busting was cool", start_date: (Time.current.strftime("%y-%m-%d").to_date + 1), duration: "2", active_calorie_goal: "300", points_worked_out: "10", points_tracked_food: "10", points_met_calorie_goal: "10", points_maintain_weight: "10", points_maintain_body_fat: "10", points_met_active_calorie_goal: "10", user: kris)
...
# Challenge 2
c2 = Challenge.create(name: "The Humiliation Challenge", description: "Everyone is going to see what you did ;)", start_date: (Time.current.strftime("%y-%m-%d").to_date + 16), duration: "2", active_calorie_goal: "250", points_worked_out: "15", points_tracked_food: "15", points_met_calorie_goal: "15", points_maintain_weight: "20", points_maintain_body_fat: "10", points_met_active_calorie_goal: "10", user: kris)
    # Set Challenge End Date
...
# Challenge 3
c3 = Challenge.create(name: "Tim's Body Fat Liquidator", description: "The way of the Samurai", start_date: (Time.current.strftime("%y-%m-%d").to_date + 30), duration: "6", active_calorie_goal: "400", points_worked_out: "20", points_tracked_food: "15", points_met_calorie_goal: "15", points_maintain_weight: "10", points_maintain_body_fat: "10", points_met_active_calorie_goal: "10", user: tim)
    #Set Challenge End Date
